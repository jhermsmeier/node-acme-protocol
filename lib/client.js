...
Client.prototype = {
  ...
  newAuthorization: function( callback ) {
    ...
    debug( 'new_authorization:payload', JSON.stringify( body ) )

    this._request.post( '/acme/new-authz', {
      body: body,
      headers: {
        'Content-Type': 'application/jose+json',
      },
      ...
      debug( 'new_authorization:response:headers', response.headers )
      debug( 'new_authorization:response:body', body )
  ...
  newApplication: function( callback ) {
    ...
    debug( 'new_application:payload', JSON.stringify( body ) )

    this._request.post( '/acme/new-app', {
      body: body,
      headers: {
        'Content-Type': 'application/jose+json',
      },
      ...
      debug( 'new_application:response:headers', response.headers )
      debug( 'new_application:response:body', body )
