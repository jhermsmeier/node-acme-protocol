...
suite( 'ACME Cert Sequence', function() {
  ...
  test( 'update registration w/ agreement', function( done ) {
    ...
    var expectedPostData = JSON.stringify({
      ...
      protected: '',
      header: {
        alg: 'RS256',
        jwk: {
          kty: 'RSA',
